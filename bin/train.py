...
if __name__ == '__main__':
    ...
    ae1 = AutoEncoder(model=autoencoder.Model1, dataset_path='..')
    ae1.compile()
    hae1 = ae1.fit(epochs=10, repeat=1, batch_size=8,
                   fname='autoencoder-Model1', fname_enc='encoder-Model1')
    ...
    cnn1 = CNN(model=cnn.Model1, encoder='encoder-Model1', encoder_version=0, dataset_path='..')
    cnn1.compile()
    hcnn1 = cnn1.fit(epochs=10, repeat=1, batch_size=8, fname='cnn-Model1')
